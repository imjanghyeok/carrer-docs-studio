...
export function defaultDataDirectory(
  ...
  if (platform === 'darwin')
    return path.join(home, 'Library', 'Application Support', 'Career Studio');
  if (platform === 'win32')
    return path.join(env.LOCALAPPDATA || path.join(home, 'AppData', 'Local'), 'Career Studio');
...
export async function containedFile(directory, relative) {
  ...
  if (!file.startsWith(base + path.sep))
    throw Object.assign(Error('허용되지 않은 경로입니다.'), { status: 403 });
