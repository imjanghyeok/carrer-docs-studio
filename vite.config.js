...
export default defineConfig({
  ...
  plugins: [{
    ...
    enforce: 'pre',
    transform(code, id) {
      if (!id.includes('@excalidraw/excalidraw/dist/prod/') || !code.includes('ASSETS_FALLBACK_URL')) return;
      ...
      if (!pattern.test(code)) throw Error('Excalidraw font loader changed: review the offline build adapter.');
